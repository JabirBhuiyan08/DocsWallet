...
const About = () => {
  ...
  return (
    <>
      <Helmet>
        <title>About Us - Docs Wallet</title>
      </Helmet>
      <div
        className={`max-w-screen-lg mx-auto p-6 ${isDarkTheme ? "text-white" : "bg-white text-black"}`}
      >
        <h1 className="text-4xl mt-16 font-bold text-center text-purple-700 mb-8 animate-fade-in">
          About Us
        </h1>

        <section className="mb-8 animate-slide-up">
          <h2 className="text-2xl font-semibold text-violet-700 mb-4">Our Mission</h2>
          <p
            className={`leading-relaxed ${isDarkTheme ? "text-gray-300" : "text-gray-600"}`}
          >
        ...
        <section className="mb-8 animate-slide-up delay-200">
          <h2 className="text-2xl font-semibold text-violet-700 mb-4">Why We Started</h2>
          <p
            className={`leading-relaxed ${isDarkTheme ? "text-gray-300" : "text-gray-600"}`}
          >
        ...
        <section className="mb-8 animate-slide-up delay-400">
          <h2 className="text-2xl font-semibold text-violet-700 mb-4">What We Offer</h2>
          <ul
            className={`list-disc ml-6 ${isDarkTheme ? "text-gray-300" : "text-gray-600"}`}
          >
            <li className="mb-2">
        ...
        <section className="mb-8 animate-slide-up delay-600">
          <h2 className="text-2xl font-semibold text-violet-700 mb-4">Our Vision</h2>
          <p
            className={`leading-relaxed ${isDarkTheme ? "text-gray-300" : "text-gray-600"}`}
          >
        ...
        <section className="mb-8 animate-slide-up delay-800">
          <h2 className="text-2xl font-semibold text-violet-700 mb-4">Our Commitment</h2>
          <p
            className={`leading-relaxed ${isDarkTheme ? "text-gray-300" : "text-gray-600"}`}
          >
        ...
        <footer
          className={`text-center mt-12 animate-fade-in delay-1000 ${isDarkTheme ? "text-gray-300" : "text-gray-600"}`}
        >
